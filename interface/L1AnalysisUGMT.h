...
namespace L1Analysis
{
  ...
  public:
    ...
    void Set(const l1t::MuonBxCollection&, const L1TRegionalMuonColl&, const L1TRegionalMuonColl&, const L1TRegionalMuonColl&, const L1TRegionalMuonColl&, const L1TRegionalMuonColl&, bool);
  ...
  private :
    ...
    TFLink matchTrackFinder(const l1t::Muon&, const L1TRegionalMuonColl&, const L1TRegionalMuonColl&, const L1TRegionalMuonColl&, const L1TRegionalMuonColl&, const L1TRegionalMuonColl&, int);
